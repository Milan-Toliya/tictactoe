...
int counter=1;
int mat[9]{38,38,38,38,38,38,38,38,38};
int matuse[9]{0,0,0,0,0,0,0,0,0};
char caller;

int checking(){
    cout<<"\nChecking for Winner...\n";
if (((mat[0] == mat[1] && mat[1] == mat [2] && mat[2] == mat[0]) && mat[1] != 38) ||
    ((mat[3] == mat[4] && mat[4] == mat [5] && mat[5] == mat[3]) && mat[4] != 38) ||
    ((mat[6] == mat[7] && mat[7] == mat [8] && mat[8] == mat[6]) && mat[7] != 38) ||
    ((mat[0] == mat[3] && mat[3] == mat [6] && mat[6] == mat[0]) && mat[3] != 38) ||
    ((mat[1] == mat[4] && mat[4] == mat [7] && mat[7] == mat[1]) && mat[4] != 38) ||
    ((mat[2] == mat[5] && mat[5] == mat [8] && mat[8] == mat[2]) && mat[5] != 38) ||
    ((mat[0] == mat[4] && mat[4] == mat [8] && mat[8] == mat[0]) && mat[4] != 38) ||
    ((mat[2] == mat[4] && mat[4] == mat [6] && mat[6] == mat[2]) && mat[4] != 38)
    ){
...
if(counter%2==0){
    ...
    if(char(ch) <49 || char(ch) >57){
        cout<<"wrong choice bhai :)";
        goto recho1;
       cin>>ch;
    }
    else{}
