...
switch (int(ch)){
    case 49: if(matuse[0]==0){mat[0]=c; matuse[0]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
        case 50: if(matuse[1]==0){mat[1]=c; matuse[1]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
            case 51:  if(matuse[2]==0){mat[2]=c; matuse[2]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                case 52: if(matuse[3]==0){mat[3]=c; matuse[3]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                    case 53: if(matuse[4]==0){mat[4]=c; matuse[4]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                        case 54: if(matuse[5]==0){mat[5]=c; matuse[5]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                            case 55: if(matuse[6]==0){mat[6]=c; matuse[6]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                                case 56: if(matuse[7]==0){mat[7]=c; matuse[7]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                                    case 57: if(matuse[8]==0){mat[8]=c; matuse[8]=1;} else {cout<<"\nWarning number is already used\n"; goto rech;} break;
                                        default : cout<<"\n wrong choice \n"; goto rech;
}
